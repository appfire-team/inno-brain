...
PLAYBOOKS: dict[str, dict[str, Any]] = {
    "find_unexplored_ideas": {
        ...
        "tagline": "Diverge wide (no constraints) → inventory existing themes → white space + bridges → external signals → competitive landscape → debate → against-all-odds wedges for the Tier 2/3 candidates.",
    ...
    "discover_opportunity": {
        ...
        "tagline": "Diverge wide → ground in analogues → scan the competitive landscape → debate the top one (Bull/Bear/Customer, 2 rounds) → against-all-odds wedges if the debate pushed back.",
        "expected_duration_s": 480,
        "accepts_source_types": [],
        "artifact_type": "OpportunityScan",
        "steps": [
    ...
    "pressure_test_strategy": {
        ...
        "tagline": "Explore tensions, evaluate balance, red-team adversarially, 4-persona debate, then against-all-odds wedges if the strategy gets shredded.",

...
PLAYBOOKS: dict[str, dict[str, Any]] = {
    "find_unexplored_ideas": {
        ...
        "tagline": "Diverge wide (no constraints) → inventory existing themes → white space + bridges → external signals → competitive landscape → debate the top ideas.",
    ...
    "discover_opportunity": {
        ...
        "tagline": "Diverge wide → ground in analogues → scan the competitive landscape → debate the top one (Bull/Bear/Customer, 2 rounds).",
    ...
    "pressure_test_strategy": {
        ...
        "tagline": "Explore tensions, evaluate balance, red-team adversarially, then 4-persona debate.",
    ...
    "product_strategy_director": {
        ...
        "tagline": "Full-scope strategic review: current product + repo · MOAT audit (Product/Company/Distribution) · competitive · market shifts · opportunities · analogues · build/buy/partner · pre-mortem · red-team · 5-persona debate → Kill/Continue/Build verdict + top 3 recommendations across Product, Engineering, GTM, Marketing.",
    ...
    "build_buy_partner": {
        ...
        "tagline": "Three paths, competitor landscape, pre-mortem, then Investor/Customer/Competitor debate.",
    ...
    "premortem_plan": {
        ...
        "tagline": "Stress-test something you're about to commit to — failure imagined + red-team + quick debate.",
    ...
    "bf_idea_refinement": {
        ...
        "tagline": "Idea against the existing codebase: variants, red-team, convergence. Outputs IdeaRefinement.",
        "expected_duration_s": 180,
        "accepts_source_types": [],
